...
class UserForm(ModelForm):
	class Meta:
		model = User
		fields = ['username', 'last_name', 'first_name', 'email', 'phone', 'address', 'position', 'affiliation', 'mentor', 'personnel_number', 'badge_number', 'deposit', 'access_expiration', 'type', 'domain', 'is_active', 'training_required', 'physical_access_levels', 'qualifications', 'projects', 'fire_trained', 'mentor_trained', 'equiresp_trained', 'remarks', 'is_staff']
