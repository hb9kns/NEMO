...
urlpatterns = [
	...
	url(r'^email_broadcast/(?P<audience>tool|account|project|equiresp|mentors|pjtresp|all)/$', email.email_broadcast, name='email_broadcast'),
