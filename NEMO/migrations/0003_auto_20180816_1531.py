# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-08-16 19:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='hours_end',
            field=models.PositiveIntegerField(default=20, help_text='Time in 24 hour format of end of access, for restricted access type'),
        ),
        migrations.AddField(
            model_name='physicalaccesslevel',
            name='hours_start',
            field=models.PositiveIntegerField(default=8, help_text='Time in 24 hour format of start of access, for restricted access type'),
        ),
        migrations.AddField(
        ...
        migrations.AlterField(
            model_name='physicalaccesslevel',
            name='schedule',
            field=models.IntegerField(choices=[(0, 'Always'), (1, 'Weekday Restricted Hours'), (2, 'Weekends')]),
        ),
        migrations.AlterField(
            model_name='resource',
